...
const projects: Project[] = [
  ...
  },
  {
    ...
    disc: ["fullstack"],
    desc: "Full-stack health tracker — Flutter frontend with a custom design system, Firebase Auth + Firestore backend, and Gemini AI that explains readings in plain language with a local fallback. Automated Normal / Warning / Critical classification on medical thresholds, plus interactive trend charts. Shipped as an installable Android build.",
    tags: ["Flutter", "Firebase", "Firestore", "Gemini AI"],
